...
**Network reset** removes Wi-Fi/setup-AP credentials and creates a new setup password next boot. Enrollment, admin password, server config, cursor, energy offset, and SD history remain.
