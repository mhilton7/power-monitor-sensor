        ...
        while True:
            ...
            try:
                ...
                if not line.endswith(b"\n") and repair_tail:
                    ...
                    break
                raise SystemExit(
                    f"refusing to alter complete corrupt record at offset {offset}: {error}"
                ) from error
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Rebuild PMR1 indexes; preserve complete corrupt records"
    )
